...
const leftIconsx = navigation => (
  ...
  >
    ...
    <Icon
      ...
      color="#fff"
      style={[
        { padding: 5, backgroundColor: "red", borderRadius: 50 },
        styles.hiddenButtons
      ]}
...
const card = ({
  ...
  // const leftIcons = () => alert('yes');

  return (
    // <Swipeable renderLeftActions={() => renderIcons}>
    <View style={styles.container}>
      <View style={[styles.actNameAndTypeContainer, style]}>
        <View style={{ display: "flex", width: "50%" }}>
          <View style={styles.actNameAndType}>
            ...
            <Text
              ...
              style={[
                styles.actTypeText,
                whiteCard ? { color: "rgba(0,0,0,.5)" } : null
              ]}
            >
              {accountType}
            </Text>
        ...
        <View style={styles.membersAmtBalCurContainer}>
          {totalMembers > 0 ? members : null}
          <View style={styles.curAmtBalContainer}>
            <Text
              allowFontScaling
              style={[
                styles.totalBalance,
                whiteCard ? { color: "rgba(0,0,0,.7)" } : null
              ]}
            >
              Total Balance
            </Text>
            <View style={styles.currencyAmountContainer}>
              ...
              <Text
                ...
                style={[
                  styles.amount,
                  whiteCard ? { color: "rgba(0,0,0,.3)" } : null
                ]}
              >
                {amount}
              </Text>
