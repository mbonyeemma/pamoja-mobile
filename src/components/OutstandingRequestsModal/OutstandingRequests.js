...
export const Sample = ({
  ...
  <View>
    <View style={{ padding: '5%' }}>
      ...
      <Text>
        <Text style={{ color: '#aaa' }}>Requested by</Text>: {requestedBy}
      </Text>
      <Text>
        <Text style={{ color: '#bbb' }}>Approved by</Text>: {approvedBy}{' '}
        <Text style={{ color: 'rgba(0, 58, 238, 0.87)' }}>
          ({(approvals && approvals.length) || 0}/3)
        </Text>
      </Text>
    </View>
    <View
